...
mutable struct WeaveMol <: AbstractAtoms
    ...
    # pairs encapsulates the PairFeatureDescriptor features for a given pair of atoms in a molecule represented using PairIndexes
    pairs::Vector{PairFeatureDescriptor}
