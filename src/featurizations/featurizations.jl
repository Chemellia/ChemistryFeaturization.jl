...
featurize!(a::AbstractAtoms, fzn::AbstractFeaturization) = throw(MethodError(featurize!, (a, fzn)))

import ..ChemistryFeaturization.decode
decode(fzn::AbstractFeaturization, encoded_feature) = throw(MethodError(decode, (fzn, encoded_feature)))
