...
# ╔═╡ 9ea9924c-1e18-4421-80a7-631210a2c08f
# this will all get less ugly once everything is regsitered but while we're still working on branches it's necessary for now...
begin
    import Pkg
    Pkg.activate("./")
  #   Pkg.add([
